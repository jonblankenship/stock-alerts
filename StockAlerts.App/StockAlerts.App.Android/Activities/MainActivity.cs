...
using System;
using StockAlerts.App.Droid.Services;
using Xamarin.Forms.Platform.Android;

namespace StockAlerts.App.Droid.Activities
{
    [Activity(
        Label = "Stock Alerts",
        Icon = "@drawable/icon",
    ...
    public class MainActivity : FormsAppCompatActivity
    {
        ...
        {
            FormsAppCompatActivity.ToolbarResource = StockAlerts.App.Droid.Resource.Layout.Toolbar;
